...
import artCraft from '../assets/art.jpg'
...
const data = [
    ...
    { pic: tution, title: "Career Counselling", para: 'In Seva Srijan foundation we aims to empower individuals to make informed career choices, manage career transitions, and achieve personal and professional fulfillment by aligning their skills, interests and values with suitable career paths.', path: '/about' },
]

const WhatsNew = () => {
    return (
        <Box sx={{ p: { lg: '40px 40px', xs: '40px 20px' } }}>
            <HeadingGlobal title="Beyond Classroom" />
