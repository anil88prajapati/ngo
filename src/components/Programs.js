        ...
        <Box sx={{ m: { lg: '0px 40px', xs: '0px' }, p: { lg: '40px 40px', xs: '0px 20px' }, backgroundImage: `url(${background})`, color: textColor }}>
            ...
            <Grid container sx={{ mt: '20px', boxShadow: '1px 5px 13px -1px rgba(0,0,0,0.75)', p: { lg: '20px', xs: '0px' }, mb: '0px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Grid item lg={6} xs={12} sx={{ mb: '20px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Box sx={{ position:  'absolute', bottom: '60px', left: 0, bgcolor: '#5BA6A6', p: '5px 10px 5px 10px' }}>
                ...
                <Grid item lg={6} xs={12} sx={{ p: '0px 20px 0px 20px', mb: { xs: '20px', lg: '0px' } }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column' }} >
                        <Box sx={{ p: { lg: '10px 10px 10px 20px', xs: '5px 5px 5px 10px' }, mt: '0px' }}>
                            <Typography variant='h3' sx={{ fontWeight: 100, fontSize: { lg: '40px', md: '20px', sm: '20px', xs: '30px' } }}>OUR PROGRAMMES</Typography>
                        </Box>
                        <Box sx={{ display: 'flex', bgcolor: 'transparent', p: { lg: '10px 10px 10px 20px', xs: '5px 5px 5px 10px' }, m: '0px 0px', }}>
                            <Typography sx={{ fontWeight: 300, fontSize: { lg: '19px', md: '16px', sm: '12px', xs: '12px' } }}>
                            <Typography sx={{ lineHeight: '1.4', letterSpacing: '1.2px', fontSize: { lg: '18px', xs: '14px' } }}>{ABOUT_US_CONTENT2}</Typography>
                            </Typography>
                        </Box>
                        <Box sx={{ ml: { lg: '20px', xs: '5px' }, mt: '20px' }}>
                            <Button variant='contained' size='small' sx={{ fontSize: { lg: '14px', xs: '10px' }, textTransform: 'unset', bgcolor: 'rgb(46, 139, 87)', color: 'black', fontWeight: 600, '&:hover': { bgcolor: '#5b3c14' } }} onClick={handleClick}>Learn more</Button>
                        </Box>
                    </Box>
                </Grid>
                <Grid item lg={3.5} xs={12} sx={{ mr: '20px', mb: { xs: '20px', lg: '0px' }, ml: '20px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Box sx={{ position: 'absolute', bottom: '23px', left: 0, bgcolor: '#306A1D', p: '5px 10px 5px 10px' }}>
                ...
                <Grid item lg={3.5} xs={12} sx={{ mr: '20px', mb: { xs: '20px', lg: '0px' }, ml: '20px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Box sx={{ position: 'absolute', bottom: '23px', left: 0, bgcolor: '#FF3300', p: '5px 10px 5px 10px' }}>
                ...
                <Grid item lg={3.5} xs={12} sx={{ mr: '20px', mb: { xs: '20px', lg: '0px' }, ml: '20px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Box sx={{ position: 'absolute', bottom: '23px', left: 0, bgcolor: '#80CC33', p: '5px 10px 5px 10px' }}>
