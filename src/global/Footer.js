                ...
                <Grid item lg={2.4} xs={6} sx={{ mb: '20px' }}>
                    <Grid container sx={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Grid item>
                            ...
                            <Typography onClick={() => handleNavigation('/')} sx={{ fontSize: '14px', cursor: 'pointer', fontWeight: 500, opacity: 0.5, '&:hover': { opacity: 1 } }}>History</Typography>
                            ...
                            <Typography onClick={() => handleNavigation('/')} sx={{ fontSize: '14px', cursor: 'pointer', fontWeight: 500, opacity: 0.5, '&:hover': { opacity: 1 } }}>Where We Work</Typography>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item lg={2.4} xs={6} sx={{ mb: '20px' }}>
                    <Grid container sx={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Grid item>
                            ...
                            <Typography onClick={() => handleNavigation('/aftercare')} sx={{ fontSize: '14px', cursor: 'pointer', fontWeight: 500, opacity: 0.5, '&:hover': { opacity: 1 } }}>Juvenile Aftercare Programme</Typography>
                            <Typography onClick={() => handleNavigation('/skill-development')} sx={{ fontSize: '14px', cursor: 'pointer', fontWeight: 500, opacity: 0.5, '&:hover': { opacity: 1 } }}>Skill Development</Typography>
                            <Typography onClick={() => handleNavigation('/talent-bank-development')} sx={{ fontSize: '14px', cursor: 'pointer', fontWeight: 500, opacity: 0.5, '&:hover': { opacity: 1 } }}>Talent Bank Development</Typography>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item lg={2.4} xs={6} sx={{ mb: '20px' }}>
                    <Grid container sx={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Grid item>
                            ...
                            <Typography onClick={() => handleNavigation('/joinUs')} sx={{ fontSize: '14px', cursor: 'pointer', fontWeight: 500, opacity: 0.5, '&:hover': { opacity: 1 } }}>Donate</Typography>
