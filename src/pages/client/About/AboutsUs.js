            ...
            <Grid container sx={{ mt: "30px", p: '0px 100px' }}>
                <Grid item lg={8}>
                    ...
                    <Grid container>
                        ...
                        <Grid item lg={5} sx={{ m: '0px 30px 0px 0px', borderTop: `1px solid ${HEADER_HOVER_COLOR}`, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src={bulb} alt='bulb' style={{ margin: '30px 0px', width: '40px', height: '40px', transition: 'transform 0.3s ease', '&:hover': { transform: 'scale(1.1)' } }} />
                        ...
                        <Grid item lg={5} sx={{ m: '0px 30px 0px 0px', borderTop: `1px solid ${HEADER_HOVER_COLOR}`, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <Typography sx={{ m: '20px 0px', opacity: 0.6, letterSpacing: '1.3px', lineHeight: '22px', fontSize: '15px' }}>
                                All programs are designed to ensure that learning levels in schools and communities increase, education reaches all children who are in school or unable to use school facilities, and youth get well trained for job opportunities. Testing tools are also developed by the SSF team to check the learning levels of children so as to determine the course of action best suited to each child and to assess impact of our programs.
                            </Typography>
                        </Grid>
                    </Grid>
                    <Grid item>
                        ...
                        <Grid container sx={{ mt: '20px' }}>
                            <Grid item lg={2.6} sx={{ p: '20px 10px', mr: '20px', border: '2px solid lightgray', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                                ...
                                <Button onClick={handlePartnerClick} sx={{ p: '10px 3px', bgcolor: HEADER_HOVER_COLOR, mt: '30px', width: '100%' }}>Partner with us</Button>
                            </Grid>
                            <Grid item lg={2.6} sx={{ p: '20px 10px', mr: '20px', border: '2px solid lightgray', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
