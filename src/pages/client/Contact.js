                ...
                <Grid container sx={{ mt: '40px', p: '0px 30px', mb: '30px' }} spacing={3}>
                    <Grid item lg={6} sx={{ p: '0px 30px' }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '43px', alignItems: 'flex-start' }}>
                            ...
                            <Typography sx={{ ...boldStyle, fontSize: '16px' }}>
                                {HEAD_OFFICE_ADDRESS}
                            </Typography>
                            <Typography sx={{ ...boldStyle, fontSize: '16px' }}>{EMAIL_ADDR}</Typography>
                            <Divider sx={{ border: '1px solid lightgray', width: '200%', m: '20px 0px', opacity: 0.5 }} />
                        ...
                        <Divider sx={{ border: '1px solid lightgray', width: '200%', m: '30px 0px', opacity: 0.5 }} />
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '43px', alignItems: 'flex-start' }}>
