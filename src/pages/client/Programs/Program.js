                ...
                <Grid item lg={8}>
                    ...
                    <Grid container>
                        <Grid item lg={12} sx={{ m: '0px 70px 0px 0px', borderTop: `1px solid ${HEADER_HOVER_COLOR}`, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img onClick={() => navigate('/GoodCitizenshipProgramme')} src={apple} alt="picapple" style={{ margin: '30px 0px', width: '200px', height: '200px' }} />
                            <Typography textAlign="center" sx={{ fontWeight: 700, m: '0px', fontSize: '20px', bgcolor: 'rgb(0, 71, 171)', color: 'white',width:'200px' }}>Good Citizenship Programme</Typography>
                            ...
                            <Button onClick={() => handleLearnMoreClick('/GoodCitizenshipProgramme')} sx={{ p: '10px 3px', bgcolor: HEADER_HOVER_COLOR, mt: '30px', width: '100%',fontSize:'20px' }}>
                                Learn More
                            </Button>
                        </Grid>
                        <Grid item lg={12} sx={{ m: '0px 70px 0px 0px', borderTop: `1px solid ${HEADER_HOVER_COLOR}`, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img onClick={() => navigate('/AftercareProgramme')} src={bulb} alt="bulb" style={{ margin: '30px 0px', width: '200px', height: '200px' }} />
                            <Typography textAlign="center" sx={{ fontWeight: 700, m: '0px', fontSize: '20px', bgcolor: 'rgb(255, 117, 24)', color: 'white',width:'200px' }}>Aftercare Programme</Typography>
                            <Typography sx={{ m: '20px 0px', opacity: 0.6, letterSpacing: '1.3px', lineHeight: '22px', fontSize: '15px' }}>
                            ...
                            <Button onClick={() => handleLearnMoreClick('/AftercareProgramme')} sx={{ p: '10px 3px', bgcolor: HEADER_HOVER_COLOR, mt: '30px', width: '100%',fontSize:'20px' }}>
                                Learn More
                            </Button>
                        </Grid>
                        <Grid item lg={12} sx={{ m: '0px 70px 0px 0px', borderTop: `1px solid ${HEADER_HOVER_COLOR}`, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img onClick={() => navigate('/SkillDevelopment')} src={monitor} alt="monitor" style={{ margin: '30px 0px', width: '200px', height: '200px' }} />
                            <Typography textAlign="center" sx={{ fontWeight: 700, m: '0px', fontSize: '20px', bgcolor: 'rgb(46, 84, 61)', color: 'white',width:'200px' }}>Skill Development Programme</Typography>
                            <Typography sx={{ m: '20px 0px', opacity: 0.6, letterSpacing: '1.3px', lineHeight: '22px', fontSize: '15px' }}>
                            ...
                            <Button onClick={() => handleLearnMoreClick('/SkillDevelopment')} sx={{ p: '10px 3px', bgcolor: HEADER_HOVER_COLOR, mt: '30px', width: '100%',fontSize:'20px' }}>
                                Learn More
                            </Button>
                        </Grid>
                        <Grid item lg={12} sx={{ m: '0px 70px 0px 0px', borderTop: `1px solid ${HEADER_HOVER_COLOR}`, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img onClick={() => navigate('/TalentBankDevelopment')} src={graph} alt="graph" style={{ margin: '30px 0px',width: '200px', height: '200px' }} />
                            <Typography textAlign="center" sx={{ fontWeight: 700, m: '0px', fontSize: '20px', bgcolor: 'rgb(138, 154, 91)', color: 'white',width:'200px' }}>Talent Bank Development</Typography>
                            <Typography sx={{ m: '20px 0px', opacity: 0.6, letterSpacing: '1.3px', lineHeight: '22px', fontSize: '15px' }}>
                            ...
                            <Button onClick={() => handleLearnMoreClick('/TalentBankDevelopment')} sx={{ p: '10px 3px', bgcolor: HEADER_HOVER_COLOR, mt: '30px', width: '100%',fontSize:'20px' }}>
                                Learn More
                            </Button>
                        </Grid>
                    </Grid>
